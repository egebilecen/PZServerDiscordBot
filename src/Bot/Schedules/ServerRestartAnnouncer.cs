...
public static partial class Schedules
{
    ...
    public static void ServerRestartAnnouncer(List<object> args)
    {
        ...
        string message = string.Format(Localization.Get("sch_serverrestartannouncer_text"), 
                                       announcementPair.Key >= 60 ? announcementPair.Key / 60 : announcementPair.Key,
                                       announcementPair.Key >= 60 ? Localization.Get("gen_hours_text") : Localization.Get("gen_minutes_text"));
